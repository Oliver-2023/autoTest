...
from autotest_lib.server.hosts.tls_client_aufork import autotest_common_aufork_pb2
from autotest_lib.client.common_lib import error

PAYLOAD_TYPE = {
        'TYPE_UNSPECIFIED':
        autotest_common_aufork_pb2.FakeOmaha.Payload.TYPE_UNSPECIFIED,
        'FULL': autotest_common_aufork_pb2.FakeOmaha.Payload.FULL,
        'DELTA': autotest_common_aufork_pb2.FakeOmaha.Payload.DELTA
}
...
class TLSFakeOmaha():
    ...
    def _make_payloads(self, payloads):
        ...
        for payload in payloads:
            serialized_payloads.append(
                    autotest_common_aufork_pb2.FakeOmaha.Payload(
    ...
    def start_omaha(self,
        ...
        target_build = autotest_common_aufork_pb2.ChromeOsImage(
                gs_path_prefix=target_build)
        fake_omaha = autotest_common_aufork_pb2.FakeOmaha(
                dut=hostname,
        ...
        req = autotest_common_aufork_pb2.CreateFakeOmahaRequest(fake_omaha=fake_omaha)
