...
# source: autotest_common_aufork.proto
...
ExecDutCommandRequest = _reflection.GeneratedProtocolMessageType('ExecDutCommandRequest', (_message.Message,), {
  ...
  '__module__' : 'autotest_common_aufork_pb2'
