...
from autotest_lib.server.hosts.tls_client_aufork import autotest_common_aufork_pb2_grpc
...
class TLSConnection(object):
    ...
    def __init__(self):
        ...
        self.stub = autotest_common_aufork_pb2_grpc.CommonStub(self.channel)
        self.alive = True
