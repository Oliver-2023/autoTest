...
import autotest_common_aufork_pb2 as autotest__common__aufork__pb2
...
class CommonStub(object):
  ...
  def __init__(self, channel):
    ...
    self.ExecDutCommand = channel.unary_stream(
        ...
        request_serializer=autotest__common__aufork__pb2.ExecDutCommandRequest.SerializeToString,
        response_deserializer=autotest__common__aufork__pb2.ExecDutCommandResponse.FromString,
        )
    self.ProvisionDut = channel.unary_unary(
        '/chromiumos.config.api.test.tls.Common/ProvisionDut',
        request_serializer=autotest__common__aufork__pb2.ProvisionDutRequest.SerializeToString,
    ...
    self.ProvisionLacros = channel.unary_unary(
        ...
        request_serializer=autotest__common__aufork__pb2.ProvisionLacrosRequest.SerializeToString,
        response_deserializer=dependencies_dot_longrunning_dot_operations__pb2.Operation.FromString,
        )
    self.FetchCrashes = channel.unary_stream(
        '/chromiumos.config.api.test.tls.Common/FetchCrashes',
        request_serializer=autotest__common__aufork__pb2.FetchCrashesRequest.SerializeToString,
        response_deserializer=autotest__common__aufork__pb2.FetchCrashesResponse.FromString,
        )
    self.CreateFakeOmaha = channel.unary_unary(
        '/chromiumos.config.api.test.tls.Common/CreateFakeOmaha',
        request_serializer=autotest__common__aufork__pb2.CreateFakeOmahaRequest.SerializeToString,
        response_deserializer=autotest__common__aufork__pb2.FakeOmaha.FromString,
        )
    self.DeleteFakeOmaha = channel.unary_unary(
        '/chromiumos.config.api.test.tls.Common/DeleteFakeOmaha',
        request_serializer=autotest__common__aufork__pb2.DeleteFakeOmahaRequest.SerializeToString,
...
def add_CommonServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'ExecDutCommand': grpc.unary_stream_rpc_method_handler(
          ...
          request_deserializer=autotest__common__aufork__pb2.ExecDutCommandRequest.FromString,
          response_serializer=autotest__common__aufork__pb2.ExecDutCommandResponse.SerializeToString,
      ),
      'ProvisionDut': grpc.unary_unary_rpc_method_handler(
          servicer.ProvisionDut,
          request_deserializer=autotest__common__aufork__pb2.ProvisionDutRequest.FromString,
      ...
      'ProvisionLacros': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=autotest__common__aufork__pb2.ProvisionLacrosRequest.FromString,
          response_serializer=dependencies_dot_longrunning_dot_operations__pb2.Operation.SerializeToString,
      ),
      'FetchCrashes': grpc.unary_stream_rpc_method_handler(
          servicer.FetchCrashes,
          request_deserializer=autotest__common__aufork__pb2.FetchCrashesRequest.FromString,
          response_serializer=autotest__common__aufork__pb2.FetchCrashesResponse.SerializeToString,
      ),
      'CreateFakeOmaha': grpc.unary_unary_rpc_method_handler(
          servicer.CreateFakeOmaha,
          request_deserializer=autotest__common__aufork__pb2.CreateFakeOmahaRequest.FromString,
          response_serializer=autotest__common__aufork__pb2.FakeOmaha.SerializeToString,
      ),
