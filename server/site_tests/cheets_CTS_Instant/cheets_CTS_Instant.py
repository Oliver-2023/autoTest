...
_CTS_URI = {
        'arm': _PUBLIC_CTS + 'android-cts_instant-9.0_r16-linux_x86-arm.zip',
        'x86': _PUBLIC_CTS + 'android-cts_instant-9.0_r16-linux_x86-x86.zip',
}
...
_CTS_LATEST_URI = {
        'arm': _INTERNAL_CTS + 'android-cts_instant-9.0_r15-linux_x86-arm.zip',
        'x86': _INTERNAL_CTS + 'android-cts_instant-9.0_r15-linux_x86-x86.zip',
}
