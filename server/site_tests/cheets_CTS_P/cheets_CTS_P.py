...
_BUNDLE_MAP = {
        (None, 'arm'): _PUBLIC_CTS + 'android-cts-9.0_r19-linux_x86-arm.zip',
        (None, 'x86'): _PUBLIC_CTS + 'android-cts-9.0_r19-linux_x86-x86.zip',
        ('LATEST', 'arm'):
        _INTERNAL_CTS + 'android-cts-9.0_r19-linux_x86-arm.zip',
        ('LATEST', 'x86'):
        _INTERNAL_CTS + 'android-cts-9.0_r19-linux_x86-x86.zip',
        ('DEV', 'arm'):
