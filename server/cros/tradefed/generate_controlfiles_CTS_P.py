...
CONFIG['SPLIT_SUITES'] = {
        ...
        'RUNTIME_HINT_SECS': {
                'CtsAbiOverrideHostTestCases': 386,
                'CtsAccelerationTestCases': 344,
                'CtsAccessibility': 1166,
                'CtsAccountManagerTestCases': 558,
                'CtsActivityManagerDevice': 12682,
                'CtsAdmin': 407,
                'CtsAlarm': 1117,
                'CtsAndroid': 418,
                'CtsAnimationTestCases': 697,
                'CtsApacheHttpLegacy': 430,
                'CtsApp': 18958,
                'CtsAslrMallocTestCases': 1003,
                'CtsAssistTestCases': 857,
                'CtsAtraceHostTestCases': 422,
                'CtsAutoFillServiceTestCases': 5782,
                'CtsBackgroundRestrictionsTestCases': 423,
                'CtsBackup': 1039,
                'CtsBatterySavingTestCases': 736,
                'CtsBionicTestCases': 972,
                'CtsBluetoothTestCases': 682,
                'CtsBootStatsTestCases': 443,
                'CtsCalendarcommon2TestCases': 381,
                'CtsCameraApi25TestCases': 334,
                'CtsCarTestCases': 350,
                'CtsCarrierApiTestCases': 385,
                'CtsColorModeTestCases': 365,
                'CtsCompilationTestCases': 430,
                'CtsContactsProviderWipe': 394,
                'CtsContentTestCases': 1683,
                'CtsCppToolsTestCases': 434,
                'CtsCurrentApiSignatureTestCases': 415,
                'CtsDatabaseTestCases': 718,
                'CtsDebugTestCases': 362,
                'CtsDeqpTestCases.32': 46465,
                'CtsDeqpTestCases.64': 20033,
                'CtsDevice': 2973,
                'CtsDexMetadataHostTestCases': 467,
                'CtsDisplayTestCases': 397,
                'CtsDpi': 377,
                'CtsDreamsTestCases': 404,
                'CtsDrmTestCases': 385,
                'CtsDumpsysHostTestCases': 1342,
                'CtsDynamicLinkerTestCases': 475,
                'CtsEdiHostTestCases': 475,
                'CtsEffectTestCases': 345,
                'CtsExternalS': 373,
                'CtsFileSystemTestCases': 7451,
                'CtsFragment': 641,
                'CtsGestureTestCases': 372,
                'CtsGpuToolsHostTestCases': 450,
                'CtsGraphicsTestCases': 1495,
                'CtsHardwareTestCases': 354,
                'CtsHarmfulAppWarningHostTestCases': 466,
                'CtsHiddenApi': 965,
                'CtsHostTzDataTests': 436,
                'CtsHostside': 3407,
                'CtsIcuTestCases': 2447,
                'CtsIncidentHostTestCases': 1399,
                'CtsInlineMockingTestCases': 345,
                'CtsInputMethod': 1022,
                'CtsIntentSignatureTestCases': 384,
                'CtsJankDeviceTestCases': 524,
                'CtsJdwp': 1260,
                'CtsJniTestCases': 352,
                'CtsJobScheduler': 836,
                'CtsJvmti': 3126,
                'CtsKernelConfigTestCases': 418,
                'CtsKeystoreTestCases': 4243,
                'CtsLeanbackJankTestCases': 391,
                'CtsLegacyNotificationTestCases': 425,
                'CtsLibcore': 12613,
                'CtsLiblogTestCases': 767,
                'CtsLocation': 584,
                'CtsLogdTestCases': 521,
                'CtsMediaBitstreamsTestCases': 2061,
                'CtsMediaHostTestCases': 369,
                ...
                'CtsMultiUser': 395,
                'CtsNNAPITestCases': 2905,
                'CtsNative': 947,
                'CtsNdefTestCases': 380,
                'CtsNet': 3317,
                'CtsOmapiTestCases': 359,
                'CtsOpenG': 1249,
                'CtsOs': 1753,
                'CtsPdfTestCases': 1189,
                'CtsPerfettoTestCases': 343,
                'CtsPermission': 1151,
                'CtsPreference': 1323,
                'CtsPrintTestCases': 2718,
                'CtsProtoTestCases': 372,
                'CtsProviderTestCases': 1297,
                'CtsRenderscript': 836,
                'CtsRs': 849,
                'CtsSample': 445,
                'CtsSaxTestCases': 354,
                'CtsSeccompHostTestCases': 405,
                'CtsSecureElementAccessControl': 448,
                'CtsSecurity': 1382,
                'CtsSelinuxTargetSdk': 385,
                'CtsSensorTestCases': 2499,
                'CtsShortcut': 2561,
                'CtsSimRestrictedApisTestCases': 338,
                'CtsSimpleCpuTestCases': 1056,
                'CtsSimpleperfTestCases': 642,
                'CtsSkQPTestCases': 914,
                'CtsSliceTestCases': 443,
                'CtsSpeechTestCases': 362,
                'CtsStatsdHostTestCases': 2942,
                'CtsSustainedPerformanceHostTestCases': 382,
                'CtsSync': 594,
                'CtsSystem': 523,
                'CtsTelecom': 436,
                'CtsTelephony': 596,
                'CtsTextTestCases': 1091,
                'CtsTheme': 586,
                'CtsToast': 698,
                'CtsTransitionTestCases': 754,
                'CtsTrustedVoiceHostTestCases': 348,
                'CtsTv': 400,
                'CtsUi': 1356,
                'CtsUidIsolationTestCases': 368,
                'CtsUsageStatsTestCases': 1712,
                'CtsUsbTests': 329,
                'CtsUtilTestCases': 390,
                'CtsVideoTestCases': 6427,
                'CtsViewTestCases.32': 2481,
                'CtsViewTestCases.64': 2706,
                'CtsVmTestCases': 370,
                'CtsVoice': 431,
                'CtsVrTestCases': 377,
                'CtsWebkitTestCases': 1363,
                'CtsWidgetTestCases': 3442,
                'CtsWindowManagerDeviceTestCases': 716,
                'CtsWrap': 474,
                'cts-system-all.api': 379,
                'signed-CtsSecureElementAccessControl': 388,
                'vm-tests-tf': 5356,
        },
}
...
CONFIG['PUBLIC_EXTRA_MODULES'] = {
        'arm': {
                'CtsDeqpTestCases': _public_deqp_submodules,
...
CONFIG['EXTRA_COMMANDLINE'] = {
        ...
        ['--include-filter', 'CtsSenorTestCases', '--abi', 'armeabi-v7a'],
}
